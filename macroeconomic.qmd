...
-   The CPI for October 2024 is scheduled to be released on November 13, 2024, at 08:30 a.m. (ET).

Source: [Federal Reserve](https://www.federalreserve.gov/publications.htm)

## [**Interest rates**]{style="color: #9D0F6A ;"}

-   United States Central Bank Rate stands at 5.0%, following the most recent adjustment in August 2024.
...
-   The volume of new car sales does not follow the same trend as population growth. It requires a deeper analysis to identify cause-and-effect relationships, but for now, the hypotheses raised are accessibility and the durability of the vehicles @autolinenetwork2024.
