...
-   Real gross domestic product increased at an annual rate of 2.3% in the fourth quarter of 2024 accordind to the advance estimate(January 30,2025).Drivers are consumer spending, and government spending. In the third quarter, real GPD increased 3.1%.

-   Personal consumption expenditures increased 4.2%, compared with 3.7% in the third quarter, according to the advance estimate(January 30,2025:T1).

-   Personal saving was \$896.4 billion in the fourth quarter. The personal saving rate as a percentage of disposable personal income was 4.1% in the fourth quarter, compared with 4.3% in the third quarter, according to the advance estimate(January 30,2025:T8)

-   Gross private domestic investment was -5.6% in the fourth quarter of 2024, compared with 0.8% in the third quarter, according to the advance estimate(January 30,2025:T1). There was a -7.8% decrease in equipment in the fourth quarter, compared to 10.8% in the third quarter.

-   Government consumption expenditures and gross investment was 2.5% in the fourth quarter compared with 5.1% in the third quarter of 2024.

**GPD for 2024**

Real GDP increased 2.8 percent in 2024, compared with an increase of 2.9 percent in 2023(% change from preceding year). Drivers are consumer spending, investment, government spending, and exports.
...
Last update: January, 2025. Souce: [Bureau of Economic Analysis](https://www.bea.gov)

**CPI (Consumer Price Index)**

-   The annual inflation rate for the United States was 2.9% for the 12 months ending December 2024, compared to the previus rate of 2.7%, acording to U.S. Bureau of Labor Statistics data published on January 15, 2025.

-   CPI measures the average change in prices of a basket of good and services and often used for cost of living adjustments, wage negotiations, social security benefits. Only counts out-of-pocket expenditures(you pay directly)

-   The CPI price index for December 2024 increased 0.4% from the preceding month.
...
-   The CPI for January 2025 is scheduled to be released on February 12, 2025, at 08:30 a.m. (ET).

Last update: January, 2025. Source: [Bureau of Labor Statistics](https://www.bls.gov/)

-   From the same month over year ago, the consumer price index (CPI) for December increased 2.9%, acording to Federal Reserve Economic Data.

![](images/clipboard-2010062285.png) Last update: January, 2025. Source: [Federal Reserve](https://www.federalreserve.gov/publications.htm)

## [**Interest rates**]{style="color: #9D0F6A ;"}

-   United States Central Bank Rate stands at 4.50%, following the most recent adjustment in January 2025.
...
>
> Longer-term inflation expectations appear to remain well anchored, as reflected in a broad range of surveys of households, business, and forecasters, as well as measures from financial markets.
>
> Over the course of our three previous meetings, we lowered our policy rate by a full percentage point from its peak. That recalibration of our policy stance was appropriate in light of the progress on inflation and the rebalancing in the labor market. With our policy stance significantly less restrictive than it had been, and the economy remaining strong, we do need to be in a hurry to adjust our policy stance. At today's meeting, the Committee decided to maintain the target range for the federal funds rate at 4-1/4 to 4-1/2 percent.
>
...
Last update: January, 2025. Source: [Federal Reserve](https://www.federalreserve.gov/publications.htm)

## [**Labor Market**]{style="color: #9D0F6A ;"}

-   Total nonnfarm payroll employment rose by 256k in December 2024 trended up in hearth care, government,and social assistance. Retail trade added jobs in December, following a job loss in Novermber 2024.

-   Unemployment rate in December, 2024 is 4.1% or 6.9 million people. The long-term unemployed(\>27 weeks or more) was 1.6 million up by 278 thousand from a year earlier that represents 22.4% of all unemployed people.

-   The labor force participation rate in December 2024 was 62.5%, was unchanged over the month and has remained in a narrow range of 62.5% to 62.7% since December 2023.

-   One important indicator of labor market is the continuing claims that track the number of residents filing for ongoing unemployment benefits in a given week. The number of continuing claims in December, 2024 is 1.86 million.
...
Last update: January, 2025. Source: Federal Reserve and [U.S. Bureau of Labor Statistics](https://www.bls.gov/) and [U.S. Departament of Labor](https://www.dol.gov)
...
There was overcapacity in carrier population during the period from 2020 to 2023 due to demand that has been inconsistent over time and is currently undergoing adjustments. However, capacity still presents high values in relation to volumes pressuring agents to adjust their operations in striving for efficiency gains. Some of those carriers are contracting and reducing their fleets sizes in order to move forward. On the other side the carriers population are reduced in 33.200 from december of 2022 to october of 2024. February is historically one of the slowest month in the trucking industry however when comparing year-over-year data the volumes(except flat-bed) and rates(all those three equipment types) in the general market are down

-   Tender rejections are currently in 5.65% in February 2025 compare to 4.5% in June 2024.

-   Diesel prices are \$3.69 per gallon in February 2025, -3.1% compare to \$3.81 per gallon in june 2024.

-   Dry van in spot market currently \$1.92 per mile -5% YoY and -13.2% over five years(\$2.22-2019).

-   Reefer in spot market currently \$2.23 per mile -5% YoY and -11.8% over five years(\$2.53-2019).

-   Flat bed in spot market currently \$2.27 per mile -2.4% YoY and -9.8% over five years(\$2.52-2019).
...
-   Spring is busiest time for the housing market in U.S. starting in April and peaks in June when the average number of existing homes sold per day increases significantly, and historically home prices tend to rise during this period. On the other hand, home prices prices rose 16.7% and 13% in 2021 and 2022 respectively way above the income and this factor may change the effect of this year season. With builders facing challenges in passing on costs to consumers, improving proceses can be a relevant factor in avoiding or minimizing the effects on margins.
...
-   Looking at the manufacturing plants construction sites.
    ...
    -   **Batteries:** Sakuu & SK on, Toyota (Liberty, NC:Production pilot Apr25), LG Energy(Queen Creek, AZ), Redwood (Reno, NV), Panasonic(De Soto, KS:WIP Start production in Spring25), Ford SK (Stanton, TN:WIP Delay until 2027)
