...
-   The annual inflation rate for the United States was 2.5% for the 12 months ending August, compared to the previus rate increase of 2.9%, acording to U.S. Labor Departament data published on August 14, 2024.

-   The PCE price index for August increased 0.2% from the preceding month, and 2.5% year-over-year.
...
-   From the same month over year ago, the consumer price index (CPI) for August increased 2.59%, acording to Federal Reserve Economic Data.
...
-   There was a signal in the sppech at Jackson Hole, which marked the edn of the four-year cycle where there was an increase in interest rates by the FED.

-   The new cycle try to normalize ultil the economy going back to normal interest rates curver looks like in the U.S. for hundred years.

> Normancy is a positivly sloped yield curve and we think the terminal rate in FED funds is 3%. Where should 10 years be if we're at 3%? We should at least be 100 to 150 basis point positively sloped.
>
> — Gary Cohn
