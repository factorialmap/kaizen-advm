...
-   Looking at the manufacturing plants construction sites.
    ...
    -   **Semiconductor:** TSMC (Phenix, AZ:TSM) , Wolfspeed(Pittsboro,NC:WOLF), Intel(Licking County, OH:INTC), SK Hynix(West Lafayette, IN), IBM(Hudson Valley, NY), GlobalFoundries(Essex, VT:GSF), Samsung(Taylor, TX:SSNLF), Texas Instruments(Sherman, TX:TXN)
