...
-   Use of Machine Learning Models and Generative AI in PDCA Method and Quality Tools implementation
    ...
    -   The basic idea of PDCA method is create a universal language to serve as a guide for thinking during problem-solving. If language is the vehicle of thought @wittgenstein2022, PDCA is a way to make that vehicle faster.

        ![PDCA (Plan-do-check-action) Method](img/PDCA.png)

    -   The basic idea of Lean principles is to focus on the customer. That requires a smooth flow in production and elimination of waste during the value-adding process. The quality is built into every step (e.g engineering, production, shipping) making it more adaptable to changing environment, and improvement is driven by workers. Value in this case, is how much the customer is willing to pay for something.
        ...
        -   Non-value added activity pure waste: No value is created and concumes resources for example inventory, rework, excess steps and checks, accidents, scraps, waiting times.

    -   The basic idea of the quality tools is reduce the waste (e.g. time, effort, unnecessary movement) during performing a value-added task or process.

    -   How generative AI tools can be useful in developing lean culture in business?

    -   How to incorporate lean principles, PDCA method nad quality tools into an AI agent and make it useful in solving problems in manufacturing?
