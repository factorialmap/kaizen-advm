...
- Raise São Paulo's reading and math to OECD levels, reach 3.5 million students across 5,000 state schools, unlock 40+ billion dollars in annual economic impact.
...
- Built predictive models and psychometric analysis using mixed effects, item response theory(IRT), survival analysis, structural equation modeling, topological data analysis, and cumulative link models(ordinal regression).
