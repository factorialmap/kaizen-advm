...
The goal was to build a tool that would help in decision-making to reduce COGS(cost of good sold) by 2%. COGS, in turn, represented 80% of the company's revenue.
...
-   Develop an intergrated planning system using linear programming to assist in strategic decisions.
...
My job was to help improve the company's valuation by developing a system that helps financial and compliance managers make better decisions using a data-driven approach.
...
My job was to help achieve the strategy of opening new stores, increasing sales in existing stores, and improving the quality of services offered to consumers.
...
-   My job was to help with the scale, maintaining the existing quality of fulfillment operations and improving the quality of services. Later, the CEO called me to contribute to the  strategy by using data creating an information system(ERP + Business Intelligence), and the goals expanded to:
