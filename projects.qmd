---
title: "Projects"
subtitle: "What have I built or contributed that demonstrates my expertise?"
---
...
- Our problem was a multi-echelon, multi-product, multi-destination combinatorial supply network optimization problem
  - 13 industrial plants
  - Dismantling cattle (22+parts)
  - Separation of cuts + variable yeilds
  - Multi-line processing(Cooked, Beef Jerky, Frozen, Chilled, Pouch, etc)
  - Allocation for markets with different prices, demand, and transportation costs.
...
- Generates a MILP(Mixed-Integer Linear Program) as a tool to drive strategic decisions and reduce COGS(cost of good sold).
...
- Implementation of the Intelligence Center of the São Paulo State Department of Education.
- Raise São Paulo's reading and math to OECD levels, reach 3.5 million students across 5,000 state schools;unlock 40-45 billion dollars in annual economic impact.

### [**Activities**]{style="color: #9D0F6A ;"}

- Data science consultancy, integrating the project's Information Technology team.

- Analyzed raw data and transformed it into high-quality, reliable datasets.

- In-depth study for the development of structured rubrics.

- Built predictive models and psychometric analysis using mixed effects, item response theory(IRT), survival analysis, structural equation modeling, and cumulative link models(ordinal regression).
...
![Critical Success Factors](img/education_pillars.png)
...
![Theory](img/education_grade_theory.png)
...
![Using NAEP visual chart - Source SARESP 2025;Dados abertos da educação](img/saresp_2025.png)

## Math

![Math results - Source SARESP 2025;Dados abertos da educação](img/education_grade_score_evolution_math.png)

## Reading

![Reading results - Source SARESP 2025;Dados abertos da educação](img/education_grade_score_evolution_reading.png)
:::
