...
- Built socioeconomic models using mixed effects, Item Response Theory(IRT), Survival Analysis, Structural Equation Modeling, and Cumulative Link Models(Ordinal Regression).
