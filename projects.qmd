...
- Design and develop student evaluation reports using RAG & MCP methodos with LLM models, and train the team.

- Create class evaluation reports applying Cohen's d, RAG, MCP methods with LLM models, and train the team.
