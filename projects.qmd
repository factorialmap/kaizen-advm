...
- Analyze variations and identify patterns in SARESP assessment data.
...
- Design and develop student evaluation reports using RAG & MCP methodos with LLM models; Train the team.

- Create class evaluation reports applying Cohen's d, RAG, MCP methods with LLM models; Train the team.

- Design pilot project of predictive models replication VAAR calculations for education fund resource allocation.

- Conduct correlation studies between class schedules and performance at student, class, school, and city levels.
...
![Kaizen project in education sector](img/fipe_project.png)
