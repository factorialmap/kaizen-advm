---
title: "U.S. Advanced Manufacturing Landscape"
subtitle: "How do I understand the national advanced manufacturing ecosystem and its priorities?"
...
### [The Ripple Effect: Why Our Choices Matter]{style="color: #9D0F6A ;"}
...
## [The Roots: How We Solved the Impossible]{style="color: #9D0F6A ;"}
...
## [The Now: Navigating a Changing World]{style="color: #9D0F6A ;"}
...
![U.S. R&D spend over GPD](img/r_and_d.png)
...
![Global robot density in 2023](img/robots.png)
...
![U.S. Manufacturing Construction Investments](img/us_mfg_construction.png)

## [The Horizon: Connecting the Dots]{style="color: #9D0F6A ;"}
...
-   **Shorten the distance** Improving the flow of traded goods transforming trade, industry, agriculture, and communication in the region and across the country.
    ...
    -   **Satelite high speed internet communication** More information, education, and acessibility.
...
-   **New processes**: Making better products, faster and cheaper.
...
## [The Toolkit: Learning How to Thrive]{style="color: #9D0F6A ;"}
