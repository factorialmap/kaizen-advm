---
title: "Advanced Manufacturing Trends"
...
-   Intel has been awarded \$8.5 billion in grants and \$11 billion on loan guarantees for new chip fab construction under the CHPS Act acording to @manufacturingmit2024. Pat Gelsinger CEO of the company is in 3 years into a turn-around strategy to get back to advanced chip production leadership, and argued the cutbacks were necessary to generate funding for his strategy of building a foundry business to achieve 5 nodes in 4 years. Bad decisions are made along the way such as make gpu chips for AI, adopting advanced lithography, and expand beyond its very profitable x86-based desktop and server chip business. 

In Dec 2, 2024 CFO David Zinsner and Michelle Holthaus will serve as interim CEOs of Intel while the board searches for a sucessor for Mr. Gelsinger. Chip design involves creating the specifications and architecture of semiconductor chips, while foundries are specialized manufacturing facilities that produce these chips based on the designs provided by companies. Essentially, chip designers focus
on the conceptual side, and foundries handle the physical production.

In Mar 12, 2024 Intel announced Lip-Bu Tan as a new CEO.

-  In Oct, 2025 Wolfspeed received $750 million in grant money from the federal chips act. There is a big transition in products and building a new giant plant for silicon carbide materials in Siler City(Chatham County) and other in Upstate New York. Wolfspeed is also partening with local community colleges to offer courses to people who would want to work at the factory that they called TCP or technician certification progam.

-  In Mar 4, 2025 TSMC announces \$100 billion more in Phoenix, AZ manufacture site.  At total now of \$165 billion investing in more three fullscale fabrication facilities, two new packaging plants, and one R&D center.


### [**Battery and electricity**]{style="color: #9D0F6A ;"}
...
-   Dry-process maufacturing with its electrode printing eliminates the use of solvents and enables the use of new process in battery manufacturing that will enable cost-effective, higher performance batteries that are also environmentally friendly. 
...
-   The world cancer incidence is increasing from 15 million cases every year to probably +30 million in 2050 reflecting a demographic shifts around the world, people live longer, risk factors and better ways to detecting cancer. The mortality rate actually going down in the last 30 years. The goals is treatment such as target therapy to be targeting cancer cells only that express some specific proteins that attract the antibody like GPS system process.
...
> 	GE Aerospece delivered a strong finish to 2024 given robust demand for our services and products with fourth quarter orders up 48%, EPS more than doubling, and free cash flow increasing over 20%. 
>	
> 	Looking to 2025, we expect double-digit revenue and EPS growth wth greather than 100% free cash flow conversion. Guided by **Flight Deck, our proprietary lean operating model**, I'm confident in **our ability to accelerate output and deliver for our customers**
>
> — Larry Culp - GE Aerospace Chairman and CEO
...
![Process Capability](img/measure_process_capability.png)

### [**Robotics**]{style="color: #9D0F6A ;"}

**General idea**

-   Robots becoming increasingly prevalent in almost every industry, from healthcare and manufacturing to defense and education. The operational cost of $5.20 per hour will bring improvements in competitiveness to the American industry.
...
## Optimus G2
![Tesla Optimus G2 - USA](img/robot_optimus.png)

## GR00T
![Nvidia Project GR00T - USA](img/robot_groot.png)

## 1X NEO
![1X NEO - Norway](img/robot_1xneo.png)

## GR-1
![Fourier GR-1 - SG](img/robot_gr1.png)

## Phoenix
![Sanctuary AI Phoenix - CAN](img/robot_phoenix.png)

## Apollo
![Apptronik Apollo - USA](img/robot_apollo.png)

## Digit
![Agility Digit - USA](img/robot_digit.png)

## Atlas
![Boston Dynamics Atlas - USA](img/robot_atlas.png)

## Dex5
![Unitree Dex5 - China](img/robot_dx5.png)

## MenteeBot
![Mentee MenteeBot - Israel](img/robot_menteebot.png)

## Kaleido
![Kawazaki Kaleido - Japan](img/robot_kaleido.png)
