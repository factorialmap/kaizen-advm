...
- Fanuc Corp: Oshino-mura, Yamanashi, operates in the supply of factory automation, robots, and root machines. The company offers products of the CNC series, servo motors, lasers, injection molding machines, wire-cut discharge machines, and ultra-precision machines.
...
- Yaskawa Electric(YASKY):  Kitakyushu, Fukuoka makes AC inverters, servos, motion controllers, ac motors drivers, and industrial robots. The company operates in sectors of robotcics,system engineering, and motion control.
...
- Rockwell Automation(ROK): Milwaukee, Wisconsin provide systems, motor control equipment, sensors, and industrial control panels.
...
- Astrobotic Pittsburg Pennsylvania: developing space robotics technology for lunar and planetary missions.

- Hamilton Robotics Reno Nevada USA: Liquid handling systems for fully automated workflows for assays, ranging from low-throughput pipetting protocols to high-thorughput systems.

- Medacta Group: Surgical robots, opthopedic robots.
...
- Vecna Robotics: Walthman, MA makes robotics used in manufacturing, warehousing fulfillment, transporting, lifting and conveying all types of materials in human-centric enribonments.

- Zebra(ZBRA): Loncolnshire, Illinois offers a retail robots solving problems like out of stock products, incorrect pricing, and high labor costs. Also provide barcode technology, RFID readers, printers, and real-time data capture machines.
