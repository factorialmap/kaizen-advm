...
-   Videos that may be useful: Industry Talks E11: James P. Womack on YouTube

**Summary**

-   Overview about productivity, quality defects, training hours between North American and Japanese manufacturing in 1990.

-   Lean thinking, knowledge-driven, and customer focused process through which all people in a defined enterprise continuously eliminate waste and create value.

-   Lean thinking is a way of thinking and a set of practices focused o creating more value with less rosources. It involves constantly experimenting and improving to eliminate waste and optimize the entire value stream, from wao materials to the customer.
...
![Example of value-added](img/muda_example.png){alt="Example of value-added"}
...
-   Key principles of Lean thinking
    ...
    -   Pull: Produce onl what is needed, when it is needed

    -   Perfection: Continuously strive for perfection by eliminating waste and improving processes.

-   Lean's succes hinges on a strong social contract between employees and the company, fostering a cultura of continuous improvement. Workers will only contribute ideas if they feel the arrangement is fair and mutually beneficial. Employees are commited to dedicate themselves to their jobs, while the company is commited to provide opportunities for skill development, enabling employees to defend their jobs. This creates a resilient system when functioning correctly, but one that becomes fragile when trust erodes. 

-   Lean focused on reduce waste and six sigma focused on reduced variation. Enterprises usually adopt their own name (e.g Pratt & Whitney - ACE, US air Force - AFS021, Boeig - Lean+ , New York City Health & Hospitals Corp - Breakthrough)

![Example of basic stability](img/process_stability.png)

-   Evolution of Lean Implementation that has shifted from a consultant-driven. "quick-fix" approach to a coaching model that empowers employees to identify and solve problems themselves.
...
-   Tesla vs Toyota: Toyota started in 1935 and they only got their system perfected by the mid-1960s. It took them 30 years of experiments and they've struggled across the world to maintain the standard as they've grown.
